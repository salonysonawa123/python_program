...
age = today.year - year - ((today.month, today.day) < (month, day)) , today.month - month , today.day - day
#age_m= today.year - year - ((today.month, today.day) < (month, day)) , today.month - month - ((today.year,today.day)<(year,day)) , today.day - day - ((today.year,today.month)<(year,month))
...
#         submits = Button(text=f"your age in year month and day{age}", font_size=30)
#         self.remove_widget(self.submit)
#         self.add_widget(submits)
#         submits.bind(on_press=MyGrid)
#         self.remove_widget(submits)
#         self.add_widget(self.submit)
#
#
#
