...
input_frame.pack(side=BOTTOM)            #position of Input Frame
...
equals = Button(btns_frame, text="=", fg="black", width=10, height=3, bd=0, bg="#eee", cursor="hand1",
                command=lambda: btn_equal()).grid(row=0, column=3, padx=1, pady=1)
